...
function lua_table:Update()
	...
	lua_table.SystemFunctions:LOG("Update()") 
	...
	then
		lua_table.SystemFunctions:LOG("HandlePRE_DETECTION()	") 
		HandlePRE_DETECTION()	
	elseif lua_table.CurrentState == State.SEEK
	then
		lua_table.SystemFunctions:LOG("HandleSEEK()") 
		HandleSEEK()
	elseif lua_table.CurrentState == State.ATTACK
	then
		lua_table.SystemFunctions:LOG("HandleAttack()") 
		HandleAttack()
		Nvec3x = Nvec3x * 0.00001
		Nvec3z = Nvec3z * 0.00001
	elseif lua_table.CurrentState == State.DEATH
	then
		lua_table.SystemFunctions:LOG("HandleDeath()") 
		HandleDeath()
	end
	lua_table.SystemFunctions:LOG("Nvec3x after NormalizedirVector------------"..Nvec3x)
	lua_table.SystemFunctions:LOG("Nvec3z after NormalizedirVector------------"..Nvec3z)
	...
	lua_table.SystemFunctions:LOG("Nvec3x after VELVector------------"..Nvec3x)
	lua_table.SystemFunctions:LOG("Nvec3z after VELVector------------"..Nvec3z)
