...
function	GetTableCameraScript_v2 ()
local lua_table = {}
	...
	then
		...
		then
			...
			then
				...
				elseif lua_table["Functions_GameObject"]:GetPositionInFrustum(P1_pos_x, P1_pos_y, P1_pos_z, Layer_3_FOV_scale_1, Layer_3_FOV_scale_2) == 1 or
					   lua_table["Functions_GameObject"]:GetPositionInFrustum(P2_pos_x, P2_pos_y, P2_pos_z, Layer_3_FOV_scale_1, Layer_3_FOV_scale_2) == 1
				then
