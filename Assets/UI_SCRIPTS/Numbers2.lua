...
function lua_table:Start()
    ...
    lua_table["UI"]:SetTextNumber(HPNUMBER2, lua_table.hpValue2.hplocal2)--variables hplocal energy local de los scripts para el p2
    lua_table["UI"]:SetTextNumber(ENGNUMBER2, lua_table.engValue2.energylocal2)
end
...
function lua_table:Update()
    ...
    lua_table["UI"]:SetTextNumber(HPNUMBER2, lua_table.hpValue2.hplocal2)
