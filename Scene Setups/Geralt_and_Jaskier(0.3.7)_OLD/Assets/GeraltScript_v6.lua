...
local geralt_ability_GO_UID
	...
	--Geralt_Ultimate (Child of Geralt): 70/25/0
	--Geralt_Ability (Child of Left Hand): 70/25/0
...
function lua_table:OnTriggerEnter()
	...
	-- 	table.current_health = lua_table.current_health - 40.0
...
function lua_table:Awake()
	...
	sword_GO_UID = lua_table.GameObjectFunctions:FindGameObject("Geralt_Sword")
...
function lua_table:Update()
	...
	if collision_bool then lua_table.SystemFunctions:LOG("I TRIGGERED") end
	lua_table.SystemFunctions:LOG("Times Triggered " .. collision_num)
