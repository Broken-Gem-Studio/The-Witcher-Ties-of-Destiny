function GetTableLumberjackScript_v4()
...
local particles = {
	...
	GroundHitParticles = { GO_name = "ground_hit_particles_lumberjack", GO_UID = 0 , active = false},
...
local function HandleSEEK()
	...
	if Time_HandleSeek - CalculatePath_Timer > 300
	then
		calculatepath = true
	end
...
function lua_table:Start()
	...
	particles.GroundHitParticles.GO_UID = lua_table.GameObjectFunctions:FindChildGameObject(particles.GroundHitParticles.GO_name)
