function GetTableLumberjack_v023()
...
local function ApplyVelocity()
	...
	--TODO if fallBack == true 
	--TODO then
	--TODO 	Nvec3x = Nvec3x*-5
	--TODO end

	if lua_table.CurrentState == State.PRE_DETECTION and lua_table.CurrentSubState == SubState.PATROL and fallBack == false
	then 
	...
	elseif lua_table.CurrentState == State.SEEK and fallBack == false
	then
	...
	elseif lua_table.CurrentState == State.ATTACK and fallBack == false
	then
		Nvec3x = 0
		Nvec3z = 0
	end
