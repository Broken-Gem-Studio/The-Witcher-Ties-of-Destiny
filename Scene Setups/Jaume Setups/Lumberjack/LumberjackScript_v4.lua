...
function lua_table:Start()
	...
	AnimationRandomizer = lua_table.SystemFunctions:RandomNumberInRange(0,350)
	lua_table.SystemFunctions:LOG("JAJAJAJA"..AnimationRandomizer)
	math.floor(AnimationRandomizer 10)
	lua_table.SystemFunctions:LOG("JAJAJAJA"..AnimationRandomizer)
end
