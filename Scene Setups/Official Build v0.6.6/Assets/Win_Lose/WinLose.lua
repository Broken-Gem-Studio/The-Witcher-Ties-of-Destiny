function GetTableWinLose()
    ...
    local function Victory()
        ...
        then
            ...
            then
                ...
                lua_table.InterfaceFunctions:SetUIElementInteractable("Button", mainmenu, true)
                lua_table.GO:SetActiveGameObject(true, nextlevel)
                lua_table.InterfaceFunctions:SetUIElementInteractable("Button", nextlevel, true)
                --lua_table.GO:SetActiveGameObject(true, retry)
                --lua_table.InterfaceFunctions:SetUIElementInteractable("Button", retry, true)
            elseif lua_table.current_level == 2
            then
                lua_table.GO:SetActiveGameObject(true, only_mainmenu)
                lua_table.InterfaceFunctions:SetUIElementInteractable("Button", only_mainmenu, true)
                --lua_table.GO:SetActiveGameObject(true, only_retry)
                --lua_table.InterfaceFunctions:SetUIElementInteractable("Button", only_retry, true)
            end
        end
    end
    ...
    function lua_table:GoToMainMenu()
        ...
        lua_table.InterfaceFunctions:SetUIElementInteractable("Button", mainmenu, false)
        lua_table.GO:SetActiveGameObject(false, nextlevel)
        lua_table.InterfaceFunctions:SetUIElementInteractable("Button", nextlevel, false)
        lua_table.GO:SetActiveGameObject(false, retry)
        lua_table.InterfaceFunctions:SetUIElementInteractable("Button", retry, false)
        lua_table.GO:SetActiveGameObject(false, only_mainmenu)
        lua_table.InterfaceFunctions:SetUIElementInteractable("Button", only_mainmenu, false)
        lua_table.GO:SetActiveGameObject(false, only_retry)
        lua_table.InterfaceFunctions:SetUIElementInteractable("Button", only_retry, false)
