...
void main()
{
	//Hardcoded values by now
	//float Amplitude = 10.0;
	//vec2 FOAMDirection = vec2(0.0, 1.0);
...
void main()
{
	...
	color = texture(u_AlbedoTexture, v_TexCoords) * u_AmbientColor;// + texture(u_SpecularTexture, v_TexCoords) * 0.2;
