function GetTableHitColliderLeftLeg2KikimoraScript_v1 ()
local lua_table = {}
...
function lua_table:OnTriggerEnter()
	...
	then
        ...
        lua_table.kikimora_script.current_health = lua_table.kikimora_script.current_health - lua_table.kikimora_script.damage_received

        -- Particle activation to main script
        for i = 1, #particles.left_leg_2_blood_hit.part_childs do
	        lua_table.ParticlesFunctions:PlayParticleEmitter(particles.left_leg_2_blood_hit.part_childs[i], particles.left_leg_2_blood_hit.part_UID)
        end
