function GetTableHitColliderLeftLeg1KikimoraScript_v1 ()
local lua_table = {}
...
function lua_table:OnTriggerEnter()
	...
	then
        ...
        for i = 1, #particles.left_leg_1_blood_hit.part_childs do
	        lua_table.ParticlesFunctions:PlayParticleEmitter(particles.left_leg_1_blood_hit.part_childs[i], particles.left_leg_1_blood_hit.part_UID)
        end
