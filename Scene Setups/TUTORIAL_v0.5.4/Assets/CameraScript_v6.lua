...
function	GetTableCameraScript_v6 ()
local lua_table = {}
...
lua_table.camera_distance_layer_1 = 30
lua_table.camera_distance_layer_2 = 30
lua_table.camera_distance_layer_3 = 30

-- Angle of the camera in degrees (0 Horizontal 90 Vertical)
-- lua_table.camera_angle = 70

lua_table.camera_angle_layer_1 = 40
lua_table.camera_angle_layer_2 = 40
lua_table.camera_angle_layer_3 = 40
...
local got_pos_once = false -- used so we only use GetPosition() once (since it won't move)
