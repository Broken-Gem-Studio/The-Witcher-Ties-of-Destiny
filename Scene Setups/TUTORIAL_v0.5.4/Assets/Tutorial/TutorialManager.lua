...
local table_barril_5
local table_barril_6
local table_barril_7
local table_barril_8
...
local function Step3()
    ...
    and table_barril_5.health == 0 and table_barril_6.health == 0 and table_barril_7.health == 0 and table_barril_8.health == 0
    then
        lua_table.SystemFunctions:LOG("TEXT invisible")
        lua_table.InterfaceFunctions:MakeElementInvisible("Text", textUID)
...
function lua_table:Awake()
    ...
    barril_5 = lua_table.ObjectFunctions:FindGameObject("Barril 5")
    barril_6 = lua_table.ObjectFunctions:FindGameObject("Barril 6")
    barril_7 = lua_table.ObjectFunctions:FindGameObject("Barril 7")
    barril_8 = lua_table.ObjectFunctions:FindGameObject("Barril 8")
    ...
    table_barril_5 = lua_table.ObjectFunctions:GetScript(barril_5)
    table_barril_6 = lua_table.ObjectFunctions:GetScript(barril_6)
    table_barril_7 = lua_table.ObjectFunctions:GetScript(barril_7)
    table_barril_8 = lua_table.ObjectFunctions:GetScript(barril_8)
