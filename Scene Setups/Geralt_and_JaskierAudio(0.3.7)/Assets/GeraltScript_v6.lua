...
local function GoDefaultState()
	...
	then
		...
		then
			...
			lua_table.AudioFunctions:PlayAudioEvent("Run_fx")
			...
			lua_table.AudioFunctions:PlayAudioEvent("Walk_fx")
...
local function RegularAttack(attack_type)
	...
	then
		...
		then
			...
			lua_table.AudioFunctions:PlayAudioEvent("Attack_3_fx")
			...
			lua_table.AudioFunctions:PlayAudioEvent("Attack_1_fx")
		...
		lua_table.AudioFunctions:PlayAudioEvent("Attack_2_fx")
