...
function lua_table:Start()
    ...
    lua_table.Transform:SetPosition(-998, 1.85, -4237, lua_table.GameObjectFunctions:GetMyUID())
end
...
function lua_table:Update()
    ...
    then
        ...
        lua_table.Transform:SetPosition(pos[1], pos[2], z, lua_table.GameObjectFunctions:GetMyUID())
