...
function lua_table:Start()
	...
	-- Get colliders
	Front_Att_Coll = lua_table.GameObject:FindChildGameObject("Zomboid_Front_Att")
	Stun_Coll = lua_table.GameObject:FindChildGameObject("Zomboid_Area")
