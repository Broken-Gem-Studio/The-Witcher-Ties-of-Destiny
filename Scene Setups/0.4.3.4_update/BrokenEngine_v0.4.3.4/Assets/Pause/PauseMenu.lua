...
function lua_table:Awake()
	lua_table.pauseImage_UUID = lua_table.ObjectFunctions:FindGameObject("PauseImage")
	lua_table.geraltImage_UUID = lua_table.ObjectFunctions:FindGameObject("PauseText")
...
function lua_table:Update()
	...
	then
		...
		then
			...
			lua_table.InterfaceFunctions:MakeElementVisible("Image", lua_table.geraltImage_UUID)
			...
			lua_table.InterfaceFunctions:MakeElementInvisible("Image", lua_table.geraltImage_UUID)
			lua_table.InterfaceFunctions:MakeElementInvisible("Button", lua_table.menuButton_UUID)
			lua_table.InterfaceFunctions:MakeElementInvisible("Button", lua_table.resumeButton_UUID)
