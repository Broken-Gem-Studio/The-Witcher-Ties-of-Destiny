...
local function Idle()    
    if lua_table.hit == false and lua_table.stunned == false and currentState ~= State.KNOCKBACK
    then
        ...
        then 
            ...
            evades = evades - 1
            lua_table.AnimationFunctions:PlayAnimation("Evade", 40)  
        ...
        then
            ...
            then  
                ...
                lua_table.AnimationFunctions:PlayAnimation("Scream", 30)        
            ...
            then
                ...
                lua_table.AnimationFunctions:PlayAnimation("Roar", 40)   
        ...
        then
            ...
            then
                ...
                --lua_table.AudioFunctions:PlayAudioEvent()
                lua_table.AnimationFunctions:PlayAnimation("Alert", 30) 
...
local function Scream() 
    ...
    then    
        ...
        lua_table.SceneFunctions:Instantiate(lua_table.screamCollider_UUID, lua_table.MyPosition[1] + lua_table.X * 2, lua_table.MyPosition[2] + 2.5, lua_table.MyPosition[3] + lua_table.Z * 2, rotation[1], rotation[2], rotation[3])    
...
function lua_table:OnTriggerEnter()	
    ...
    then
        ...
        elseif player_table.control_effect == Effect.TAUNT
        then
