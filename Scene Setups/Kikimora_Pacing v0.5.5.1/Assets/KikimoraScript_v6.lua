function GetTableKikimoraScript_v6 ()
local lua_table = {}
...
local attack_pattern_cooldown = 4
...
local animation = 
{
    ...
    leash_left_anticipation = { anim_name = "leash_left_anticipation", anim_frames = 117, anim_speed = 30, anim_blendtime = 0 },
    leash_left_execution = { anim_name = "leash_left_execution", anim_frames = 23, anim_speed = 30, anim_blendtime = 0 },
    leash_left_recovery = { anim_name = "leash_left_recovery", anim_frames = 46, anim_speed = 30, anim_blendtime = 0 },
    
    leash_right_anticipation = { anim_name = "leash_right_anticipation", anim_frames = 117, anim_speed = 30, anim_blendtime = 0 },
    leash_right_execution = { anim_name = "leash_right_execution", anim_frames = 25, anim_speed = 30, anim_blendtime = 0 },
    leash_right_recovery = { anim_name = "leash_right_recovery", anim_frames = 41, anim_speed = 30, anim_blendtime = 0 },
    
    sweep_anticipation = { anim_name = "sweep_anticipation", anim_frames = 16, anim_speed = 30, anim_blendtime = 0 },
    sweep_execution = { anim_name = "sweep_execution", anim_frames = 74, anim_speed = 30, anim_blendtime = 0 },
    sweep_recovery = { anim_name = "sweep_recovery", anim_frames = 20, anim_speed = 30, anim_blendtime = 0 },
    
    sweep_left_anticipation = { anim_name = "sweep_left_anticipation", anim_frames = 53, anim_speed = 30, anim_blendtime = 0 },
    sweep_left_execution = { anim_name = "sweep_left_execution", anim_frames = 20, anim_speed = 30, anim_blendtime = 0 },
    sweep_left_recovery = { anim_name = "sweep_left_recovery", anim_frames = 24, anim_speed = 30, anim_blendtime = 0 },
    
    sweep_right_anticipation = { anim_name = "sweep_right_anticipation", anim_frames = 54, anim_speed = 30, anim_blendtime = 0 },
    sweep_right_execution = { anim_name = "sweep_right_execution", anim_frames = 15, anim_speed = 30, anim_blendtime = 0 },
    sweep_right_recovery = { anim_name = "sweep_right_recovery", anim_frames = 29, anim_speed = 30, anim_blendtime = 0 },
    
    stomp_anticipation = { anim_name = "stomp_anticipation", anim_frames = 28, anim_speed = 30, anim_blendtime = 0 },
    stomp_execution = { anim_name = "stomp_execution", anim_frames = 50, anim_speed = 30, anim_blendtime = 0 },
    stomp_recovery = { anim_name = "stomp_recovery", anim_frames = 29, anim_speed = 30, anim_blendtime = 0 },
    
    roar_anticipation = { anim_name = "roar_anticipation", anim_frames = 18, anim_speed = 30, anim_blendtime = 0 },
    roar_execution = { anim_name = "roar_execution", anim_frames = 79, anim_speed = 30, anim_blendtime = 0 },
    roar_recovery = { anim_name = "roar_recovery", anim_frames = 29, anim_speed = 30, anim_blendtime = 0 },
}
...
local function HandlePhases()
    ...
    then
        ...
        then
            ...
            animation.leash_left_anticipation =animation.leash_left_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.leash_left_execution = animation.leash_left_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.leash_left_recovery = animation.leash_left_recovery.anim_speed * lua_table.speed_modificator_phase_2
    
            animation.leash_right_anticipation = animation.leash_right_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.leash_right_execution = animation.leash_right_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.leash_right_recovery = animation.leash_right_recovery.anim_speed * lua_table.speed_modificator_phase_2

            animation.sweep_anticipation = animation.sweep_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_execution = animation.sweep_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_recovery = animation.sweep_recovery.anim_speed * lua_table.speed_modificator_phase_2
    
            animation.sweep_left_anticipation = animation.sweep_left_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_left_execution = animation.sweep_left_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_left_recovery = animation.sweep_left_recovery.anim_speed * lua_table.speed_modificator_phase_2
    
            animation.sweep_right_anticipation = animation.sweep_right_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_right_execution = animation.sweep_right_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.sweep_right_recovery = animation.sweep_right_recovery.anim_speed * lua_table.speed_modificator_phase_2
    
            animation.stomp_anticipation = animation.stomp_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.stomp_execution = animation.stomp_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.stomp_recovery = animation.stomp_recovery.anim_speed * lua_table.speed_modificator_phase_2
    
            animation.roar_anticipation = animation.roar_anticipation.anim_speed * lua_table.speed_modificator_phase_2
            animation.roar_execution = animation.roar_execution.anim_speed * lua_table.speed_modificator_phase_2
            animation.roar_recovery = animation.roar_recovery.anim_speed * lua_table.speed_modificator_phase_2
    ...
    then
        ...
        then
            ...
            -- Updating animations speed
            animation.leash_left_anticipation =animation.leash_left_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.leash_left_execution = animation.leash_left_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.leash_left_recovery = animation.leash_left_recovery.anim_speed * lua_table.speed_modificator_phase_3
    
            animation.leash_right_anticipation = animation.leash_right_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.leash_right_execution = animation.leash_right_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.leash_right_recovery = animation.leash_right_recovery.anim_speed * lua_table.speed_modificator_phase_3

            animation.sweep_anticipation = animation.sweep_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_execution = animation.sweep_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_recovery = animation.sweep_recovery.anim_speed * lua_table.speed_modificator_phase_3
    
            animation.sweep_left_anticipation = animation.sweep_left_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_left_execution = animation.sweep_left_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_left_recovery = animation.sweep_left_recovery.anim_speed * lua_table.speed_modificator_phase_3
    
            animation.sweep_right_anticipation = animation.sweep_right_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_right_execution = animation.sweep_right_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.sweep_right_recovery = animation.sweep_right_recovery.anim_speed * lua_table.speed_modificator_phase_3
    
            animation.stomp_anticipation = animation.stomp_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.stomp_execution = animation.stomp_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.stomp_recovery = animation.stomp_recovery.anim_speed * lua_table.speed_modificator_phase_3
    
            animation.roar_anticipation = animation.roar_anticipation.anim_speed * lua_table.speed_modificator_phase_3
            animation.roar_execution = animation.roar_execution.anim_speed * lua_table.speed_modificator_phase_3
            animation.roar_recovery = animation.roar_recovery.anim_speed * lua_table.speed_modificator_phase_3
...
local function HandleStates()
    ...
    then
        ...
        then
            ...
            lua_table.AnimationFunctions:PlayAnimation(animation.swap_phase.anim_name, animation.swap_phase.anim_speed, lua_table.my_UID) -- It will have a times 2 duration
...
function lua_table:Awake ()
    ...
    attack_collider.sweep.coll_ang_velocity[y] = (attack_collider.sweep.coll_final_rot[y] - attack_collider.sweep.coll_init_rot[y]) / attack.sweep.att_execution_duration 
    attack_collider.sweep.coll_ang_velocity[z] = (attack_collider.sweep.coll_final_rot[z] - attack_collider.sweep.coll_init_rot[z]) / attack.sweep.att_execution_duration 
    attack_collider.sweep.coll_init_scale[x] = 1
    attack_collider.sweep.coll_init_scale[y] = 1
    attack_collider.sweep.coll_init_scale[z] = 1 
    attack_collider.sweep.coll_final_scale[x] = 1
    attack_collider.sweep.coll_final_scale[y] = 1
    attack_collider.sweep.coll_final_scale[z] = 1
    attack_collider.sweep.coll_growth_velocity[x] = (attack_collider.sweep.coll_init_scale[x] - attack_collider.sweep.coll_final_scale[x]) / attack.sweep.att_execution_duration 
    attack_collider.sweep.coll_growth_velocity[y] = (attack_collider.sweep.coll_init_scale[y] - attack_collider.sweep.coll_final_scale[y]) / attack.sweep.att_execution_duration 
    attack_collider.sweep.coll_growth_velocity[z] = (attack_collider.sweep.coll_init_scale[z] - attack_collider.sweep.coll_final_scale[z]) / attack.sweep.att_execution_duration
