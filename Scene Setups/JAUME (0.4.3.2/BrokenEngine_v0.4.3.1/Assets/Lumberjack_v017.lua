function GetTableLumberjack_v017()
...
local attack_colliders = {
	front = { GO_name = lua_table.FrontCo_name, GO_UID = 0 , active = false},
	jump_attack = { GO_name = lua_table.JumpCo_name, GO_UID = 0 , active = false}
}
...
function lua_table:Start()
	...
	attack_colliders.jump_attack.GO_UID = lua_table.GameObjectFunctions:FindGameObject(attack_colliders.jump_attack.GO_name)
