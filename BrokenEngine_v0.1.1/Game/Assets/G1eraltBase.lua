...
lua_table.evade_duration = 400
lua_table.evade_velocity = 15
...
function ActionInputs()	--Process Action Inputs
	...
	then
		...
		lua_table.Functions:SetLinearVelocity(lua_table.evade_velocity * evade_x, mov_speed_y, lua_table.evade_velocity * evade_z)
